(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))i(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const l of t.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&i(l)}).observe(document,{childList:!0,subtree:!0});function r(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function i(e){if(e.ep)return;e.ep=!0;const t=r(e);fetch(e.href,t)}})();const a=[{name:"Artboard",blob:"Instantly support hundreds of integrations compatible  turn them on with one click.",src:"https://jadenucf.github.io/website/artboard1.png",list:["Easy, intuitive prototyping","Shared Libraries, styles and components","Control over color profiles"]},{name:"Artboard",blob:"Design and develop with other creative students",src:"https://jadenucf.github.io/website/artboard2.png",list:["Solo design or real-time collaboration","Offline and local file support","Store and sync your work","Share feedback in the app","Distribute Design Systems"]},{name:"Artboard",blob:"Instantly support hundreds of integrations compatible  turn them on with one click.",src:"https://jadenucf.github.io/website/artboard3.png",list:["Super-fast performance","Optimized for Apple Silicon","Drag and drop between apps"]}],n=a.map((o,s)=>`          
